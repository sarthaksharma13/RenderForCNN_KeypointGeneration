...
def load_one_category_shape_list(shape_synset):
    ...
    print view_num
    shape_list = [(shape_synset, '653c0f8b819872b41a6af642cfc1a2bc', os.path.join(g_shapenet_root_folder, shape_synset, '653c0f8b819872b41a6af642cfc1a2bc', 'model.obj'), view_num)]
